...
void Timer::_update_timing() {
  ...
  // use taro to run btask part
  // _run_GDCA_btask_taro();  
  _run_GDCA_btask_taro_event_trigger();
  /*
  // rebuild _taskflow by vivekDAG
  start = std::chrono::steady_clock::now();
  _rebuild_taskflow_GDCA_btask();
...
void Timer::_run_GDCA_btask_taro_event_trigger() {
...
void Timer::_run_GDCA_btask_taro() {
  // clear original taskflow
  _taskflow.clear();
