...
class Timer {
  ...
  public:
    ...
    ~Timer() {
      ...
      std::cout << "_vivek_ftask_rebuild_time: " << _vivek_ftask_rebuild_time << "\n";
      std::cout << "_vivek_ftask_runtime: " << _vivek_ftask_runtime << "\n";
  ...
  private:
    ...
    size_t _vivek_ftask_rebuild_time = 0;

    size_t _vivek_ftask_runtime = 0;
