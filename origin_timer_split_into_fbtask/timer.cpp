...
void Timer::_update_timing() {
  ...
  _build_ftask_time += std::chrono::duration_cast<std::chrono::microseconds>(end-start).count();

  // Execute the task
  start = std::chrono::steady_clock::now();
  _executor.run(_taskflow).wait();
  end = std::chrono::steady_clock::now();
  _run_ftask_time += std::chrono::duration_cast<std::chrono::microseconds>(end-start).count();
  _taskflow.clear();
  ...
  _build_btask_time += std::chrono::duration_cast<std::chrono::microseconds>(end-start).count();

  // Execute the task
  start = std::chrono::steady_clock::now();
  _executor.run(_taskflow).wait();
  end = std::chrono::steady_clock::now();
  _run_btask_time += std::chrono::duration_cast<std::chrono::microseconds>(end-start).count();
  _taskflow.clear();
