...
class Timer {
  ...
  public:
    ...
    ~Timer() {
      ...
      std::cout << "_build_ftask_time: " << _build_ftask_time << "\n";
      std::cout << "_run_ftask_time: " << _run_ftask_time << "\n";
      std::cout << "_build_btask_time: " << _build_btask_time << "\n";
      std::cout << "_run_btask_time: " << _run_btask_time << "\n";
  ...
  private:
    ...
    size_t _build_ftask_time = 0;
    size_t _run_ftask_time = 0;
    size_t _build_btask_time = 0;
    size_t _run_btask_time = 0;
